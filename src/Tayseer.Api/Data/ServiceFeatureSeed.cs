...
public static class ServiceFeatureSeed
{
    ...
    [
        ...
        F(BankingId, 2, "f02", "Smart Teller Machines (STMs)", "آلات الصراف الذكية (STM)",
        ...
        F(BankingId, 3, "f03", "Cash Sorting & Banknote Handling", "فرز النقد ومعالجة الأوراق",
        ...
        F(BankingId, 4, "f04", "Self-Service Banking Hardware", "أجهزة الخدمة الذاتية المصرفية",
        ...
        F(BankingId, 5, "f05", "Monitoring & Investigation", "المراقبة والتحقيق",
